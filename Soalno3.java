...
do { 
try { 
output = "Masukkan Saldo Rekening Anda $:"; 
...
do { 
try { 
output = "Masukkan Tingkat Bunga Tahunan Anda (dalam bentuk desimal): \n" 
+ "CONTOH: Tingkat Bunga 5% adalah 0,05"; 
input = JOptionPane.showInputDialog(output); 
...
do { 
try { 
output = "Masukkan Jumlah Penarikan:"; 
input = JOptionPane.showInputDialog(output); 
...
do { 
try { 
output = "Masukkan Jumlah Setoran:"; 
input = JOptionPane.showInputDialog(output); 
...
output = "Saldo Rekening dangan Bunga: $" + df.format(savings.getBalance()); 
output += "\nPengurangan Biaya Bulanan: $" + df.format(savings.getMonthlyCharge()); 
output += "\nStatus Rekening: "; 
...
String output; 
output = "Error: Masukkan Data Dengan Benar!"; 
JOptionPane.showMessageDialog(null, output); 
} 
